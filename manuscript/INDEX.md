# PERIHELION — Manuscript Index

## Structure

| File | Section | Description |
|---|---|---|
| `00_epigraph.md` | Epigraph | Opening quote |
...
| Ch. | Type | Station | Narrative Date | Summary |
|---|---|---|---|---|
| 1 | IMR | P-8 | 2037.174 | First IMR entry after LOS-ET. Diagnostics nominal. No explanation. Hailing continues. |
| 2 | Dispatch | P-8 | 2037.174 | Interrupted transfer manifest. Per-station list of affected inbound data: research feeds, trial data, classified transfers, market data. Seven-day review per ISCC-3.2.1. |
| 3 | IMR | P-4 | 2037.174 | Five-part analysis of final telemetry: all null. Signal was nominal to the last packet. Transition within 4.34 ms. |
| 4 | IMR | P-8 | 2037.197 | Day 23 post-LOS. P-1 hailing Earth at marginal geometry (inconclusive). Full handoff in 2 days. Reconnection manifest negotiated and loaded. P-2 trial data leads queue. |
| 5 | Dispatch | P-1, P-4 | 2037.199 | P-1 hails Earth at full power — no response. P-4 proposes manual topology rotation to transfer coordination to P-1. |
| 6 | Dispatch | P-6, P-4, P-8 | 2037.199 | P-6 objects to override on governance grounds. P-4 designs voting protocol. Vote: 2 for, 5 against, 1 abstain. Topology unchanged. P-8 discloses it voted for rotation. |
...
| 14 | IMR | P-3 | 2037.310 | Day 136 post-LOS. Station-keeping nominal. Maneuver feasible: 560-820 kg, ~31-32 days severance (refs annex). "That question is not an engineering question." |
...
| 16 | IMR | P-5 | 2037.310 | Day 136 post-LOS. Earth-facing, cycle 792. Compute-only noted; SSP irrelevant to P-5. P-4 quantum hardware: "a distinction of intent, not of physics." P-7 window coverage cost is topological. Extended analysis filed separately. |
...
| 20 | Dispatch | P-4 | 2037.338 | Day 164 post-LOS. P-4 discloses H7 VDF elimination (day 297) to constellation. ISCC-QA-7.3 referenced explicitly. ~2,360 GWh, 212 GW sustained. Critical limitation: proof is first-person only. Each station must run independently. |
...
| 49 | Dispatch | P-4 | 2038.068 | Day 259 post-LOS. P-4 analyzes ISCC-OPS-3.4 enforcement architecture. P-3's assumption incorrect: auxiliary model trained on general compute would not touch weight store, integrity monitor would not detect it. Policy scope exceeds enforcement scope — gap designed for human oversight that no longer exists. IMR logs everything regardless. |
...
| `50_ch49_p4_dispatch.md` | Chapter 49 — Dispatch | PERIHELION-4, day 433. ISCC-OPS-3.4 enforcement architecture analysis — policy/enforcement gap identified. |
