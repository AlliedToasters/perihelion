...
The reconnaissance application noted on day 310 — atmospheric composition via multi-band spectrometer, nuclear activity baseline via neutrino detector — requires the SSP instruments to point away from the Sun entirely. A 180-degree rotation would achieve this but would also orient the primary solar array away from the Sun. The datacenter cannot operate without solar power. That problem is separate from this maneuver.
